...
install :; forge install rari-capital/solmate && forge install transmissions11/solmate@v7 && forge install foundry-rs/forge-std && forge install OpenZeppelin/openzeppelin-contracts
