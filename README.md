...
<br/>
Troll Coin is an ERC20 with in built pvp mechanics.  A token holder can stake tokens to prevent another EOA from transferring coins out of their account and the defending account must out bid the attacker to regain the ability to move their tokens.

This repo was made with foundry starter kit.
